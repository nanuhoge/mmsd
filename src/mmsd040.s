...
* タイトルの表示
*----------------------------------------------------------
@@:		dc.b	'Memory management status display v1.40 for 040SYSpatch.x'
		dc.b	13,10,0
	.even
...
* 表示終了
*----------------------------------------------------------
no_040_msg:	dc.b	'040SYSpatch v2.60以降で使用してください',13,10,0
...
getmmus:	movem.l	d1/a1,-(sp)
		...
		moveq	#3,d0				* MMU table search data space
		movec	SFC,d7
		movec	d0,SFC
		
		movea.l	d1,a0
		moves.l	(a0),d1				* TIB address + field
		andi.w	#.not.%1_1111_1111,d1
		move.l	d1,(tib,a6)
		
		movea.l	d1,a0
		moves.l	(a0),d1				* TIC address + field
		andi.w	#.not.%111_1111,d1
		move.l	d1,(tic,a6)
...
preg_loop:	move.l	(xreg_msg_table,pc,d3.w*4),-(sp)
		...
		bfextu	d4{31-14:2},d1
		move.l	(fc2_msg_table,pc,d1.w*4),(sp)
		DOS	_PRINT
		
		bfextu	d4{31-2:1},d1
		move.l	(wpwe_msg_table,pc,d1.w*4),(sp)
		DOS	_PRINT
...
xreg_msg_table:	dc.l	itt0_msg
		dc.l	itt1_msg
		dc.l	dtt0_msg
		dc.l	dtt1_msg
itt0_msg:	dc.b	'ITT0',0
itt1_msg:	dc.b	'ITT1',0
dtt0_msg:	dc.b	'DTT0',0
dtt1_msg:	dc.b	'DTT1',0
...
cache_msg_table:
		...
		dc.l	ncser_msg
		dc.l	ncnser_msg
wt_msg:		dc.b	'Cachable, Writethrough',0
cb_msg:		dc.b	'Cachable, Copyback',0
ncser_msg:	dc.b	'Noncachable, Serialized',0
ncnser_msg:	dc.b	'Noncachable',0
...
enable_msg:	dc.b	'Enabled  ',0
	...
	.even
fc2_msg_table:	dc.l	fc2_user_msg
		dc.l	fc2_super_msg
		dc.l	fc2_igno_msg
		dc.l	fc2_igno_msg
fc2_user_msg:	dc.b	'USER   ',0
fc2_super_msg:	dc.b	'SUPER  ',0
fc2_igno_msg:	dc.b	'IGNORE ',0

ptop_msg:	dc.b	'040SYSpatch version '
...
preg_msg:	dc.b	'-------------------------------------------[TRANSPARENT TRANSLATION]-',13,10
		dc.b	'TT Regs.       Status   FC2    WP             Cache Mode',13,10
		dc.b	'-------------  -------- ------ -------------- -----------------------',13,10,0
